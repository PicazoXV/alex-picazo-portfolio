      ...
      <div className="about__grid">
        <div>
          ...
          <p className="about__text animate-in delay-3">
            DESARROLLADOR FULL-STACK EN ESPAÑA. GRADUADO EN DESARROLLO DE
...
<br />
<br />
ACTUALMENTE TRABAJO COMO DESARROLLADOR EN SPARO, UNA PLATAFORMA
DE ANÁLISIS DE VÍDEO CON IA PARA DEPORTES DE COMBATE, DONDE
SIGO CRECIENDO PROFESIONALMENTE Y APORTANDO MIS CONOCIMIENTOS
